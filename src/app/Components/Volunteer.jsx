...
const Volunteer = () => {
    return (
        <div id='volunteer' className='max-w-7xl mx-auto pt-[60px] flex md:flex-row flex-col-reverse lg:gap-32 md:gap-3 gap-16 mb-[60px]'>
               <div className='lg:ml-0 ml-4 lg:mr-0 mr-4'>
                ...
                <p className='mt-3  text-[#525252] font-medium lg:text-base md:text-[13px] text-sm md:hidden lg:block'>
                ...
                <p className='mt-3 md:block lg:hidden hidden  text-[#525252] font-medium lg:text-base md:text-[14px] text-sm '>
