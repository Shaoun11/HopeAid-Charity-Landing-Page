    ...
    <div className="max-w-7xl mx-auto ">
      <nav className="px-6 py-3 flex lg:flex-row flex-row-reverse justify-between items-center">
        ...
        <div className="flex items-center  gap-x-3">
          ...
          >
            {toggleMenu === true ? (
              <svg  className="lg:hidden -ml-28  text-3xl font-semibold text-[#18233B] cursor-pointer" xmlns="http://www.w3.org/2000/svg" width="30" height="40" viewBox="0 0 24 24" fill="none">
              ...
              <IoClose className="lg:hidden -ml-28 text-2xl text-[#18233B] cursor-pointer" />
            )}
